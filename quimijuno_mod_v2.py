...
class PDFToExcelConverter:
    ...
    def extrair_dados(self, texto):
        ...
        for match in matches:
            ...
            # Inicializamos as variáveis para as descrições
            descricao_principal = descricao_completa
            descricao_secundaria = ""
            descricao_terciaria = ""
            
            # Verificar se há "Equivalente" na descrição
            if " Equivalente " in descricao_completa:
                # Dividir em partes: antes do "Equivalente" e a partir do "Equivalente"
                ...
                # Verificar se há "IBC", "Cisterna" ou "Tambor" na parte após "Equivalente"
                ...
                if re.search(padrao_divisao, parte_equivalente, re.IGNORECASE):
                    # Dividir novamente para separar a parte do "Equivalente" até antes de "IBC/Cisterna/Tambor"
                    ...
                    # Se não tiver "IBC/Cisterna/Tambor", toda a parte depois de "Equivalente" vai para a descrição secundária
                    descricao_secundaria = parte_equivalente.strip()
            else:
                # Caso não tenha "Equivalente", verificamos só para "IBC", "Cisterna" ou "Tambor"
    ...
    def escrever_excel(self, produtos, caminho_excel):
        ...
        for row in range(2, current_row, 3):  # Pulando as linhas em branco
            for col in [3, 5, 6, 7]:  # Colunas numéricas
